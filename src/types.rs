...
pub struct Module {
    ...
    pub id: i64,
    pub uebersetzungen: Option<Vec<ModuleUebersetzungen>>, // Uebersetzungen
    pub nachfolger: Option<ModuleNachfolger>,              // Modules
    ...
    pub zuordnungen: Option<Vec<ModuleZuordnungen>>, // Zuordnung
    pub bezeichnung: String,
    pub zustand: String,
    pub vorgaenger: Option<ModuleVorgaenger>, // Modules
    pub semester_bewertung: String,
    pub voraussetzungen: Option<Vec<ModuleVoraussetzungen>>, // Modules
    pub dozenten: Option<Vec<ModuleDozenten>>,               // Dozent
    pub inhalt: Option<String>,                              // html
    pub kuerzel: String,
    pub empfehlungen: Option<Vec<ModuleEmpfehlungen>>, // Modules
    pub anschlussmodule: Option<Vec<ModuleAnschlussmodule>>, // Modules
